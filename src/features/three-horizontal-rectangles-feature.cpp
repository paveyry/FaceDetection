...
namespace violajones
{
  ...
  int ThreeHorizontalRectanglesFeature::compute_value(Point win_top_left, float size_ratio, IntegralImage image)
  {
  ...
  int ThreeHorizontalRectanglesFeature::compute_value(IntegralImage image)
  {
